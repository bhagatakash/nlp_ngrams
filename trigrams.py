...
c_vec = CountVectorizer(stop_words=stop_words, ngram_range=(3,3))
...
col=['Trigram','Count','DataDate', 'DateFetched','TotalNews', 'YesterDayMatch', 'PreviousMonthMatch','PreviousYearMatch']

dct={'Trigram':df_dict,'Count':len(df_dict), 'TotalNews':len(data), 'YesterDayMatch':'', 'PreviousMonthMatch':"",'PreviousYearMatch':''} 
