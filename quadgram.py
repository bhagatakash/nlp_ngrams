...
c_vec = CountVectorizer(stop_words=stop_words, ngram_range=(4,4))
...
col=['Quadgram','Count','DataDate', 'DateFetched','TotalNews', 'YesterDayMatch', 'PreviousMonthMatch','PreviousYearMatch']

dct={'Quadgram':df_dict,'Count':len(df_dict), 'TotalNews':len(data), 'YesterDayMatch':'', 'PreviousMonthMatch':"",'PreviousYearMatch':''} 
